    ...
    <table border="1">
        ...
        echo APP_ROOT;
            foreach ($data as $projects) 
            {
                ...
                echo "<td><a href='".APP_ROOT."/scripts/edit.php?id={$projects['id']}'>Edit</a> | <a href='".APP_ROOT."/scripts/delete.php?id={$projects['id']}' onclick='return confirm(\"Are you sure you want to delete this project?\");'>Delete</a></td>";
                echo "</tr>";
